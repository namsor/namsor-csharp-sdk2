...
namespace Org.OpenAPITools.com.namsor.sdk2.model
{
    ...
    public partial class FirstLastNameUSRaceEthnicityOut :  IEquatable<FirstLastNameUSRaceEthnicityOut>, IValidatableObject
    {
        ...
        public FirstLastNameUSRaceEthnicityOut(string id = default(string), string firstName = default(string), string lastName = default(string), RaceEthnicityAltEnum? raceEthnicityAlt = default(RaceEthnicityAltEnum?), RaceEthnicityEnum? raceEthnicity = default(RaceEthnicityEnum?), double? score = default(double?), List<string> raceEthnicitiesTop = default(List<string>))
        {
            this.Id = id;
