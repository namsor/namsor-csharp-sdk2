...
namespace Org.OpenAPITools.com.namsor.sdk2.model
{
    ...
    public partial class SystemMetricsOut :  IEquatable<SystemMetricsOut>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="cacheMetrics">cacheMetrics.</param>
        ...
        public SystemMetricsOut(List<CacheMetricsOut> cacheMetrics = default(List<CacheMetricsOut>), List<ClassifierMetricsOut> classifierMetrics = default(List<ClassifierMetricsOut>), List<SourceMetricsOut> sourceMetrics = default(List<SourceMetricsOut>), long? totalMem = default(long?), long? freeMem = default(long?), long? maxMem = default(long?))
        {
        ...
        /// <summary>
        /// Gets or Sets CacheMetrics
        /// </summary>
        [DataMember(Name="cacheMetrics", EmitDefaultValue=false)]
        public List<CacheMetricsOut> CacheMetrics { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CacheMetrics: ").Append(CacheMetrics).Append("\n");
        ...
        public bool Equals(SystemMetricsOut input)
        {
            ...
            return 
                (
                    this.CacheMetrics == input.CacheMetrics ||
                    this.CacheMetrics != null &&
                    this.CacheMetrics.SequenceEqual(input.CacheMetrics)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CacheMetrics != null)
                    hashCode = hashCode * 59 + this.CacheMetrics.GetHashCode();
