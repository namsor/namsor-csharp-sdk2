...
namespace Org.OpenAPITools.com.namsor.sdk2.model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpectedClassMetricsOut :  IEquatable<ExpectedClassMetricsOut>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpectedClassMetricsOut" /> class.
        /// </summary>
        /// <param name="classifierName">classifierName.</param>
        /// <param name="expectedClass">expectedClass.</param>
        ...
        public ExpectedClassMetricsOut(string classifierName = default(string), string expectedClass = default(string), long? aiEstimateTotal = default(long?), double? aiEstimatePrecision = default(double?), double? aiEstimateRecall = default(double?), long? aiLearnTotal = default(long?))
        {
        ...
        /// <summary>
        /// Gets or Sets ExpectedClass
        /// </summary>
        [DataMember(Name="expectedClass", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ExpectedClass: ").Append(ExpectedClass).Append("\n");
        ...
        {
            return this.Equals(input as ExpectedClassMetricsOut);
        }

        /// <summary>
        /// Returns true if ExpectedClassMetricsOut instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpectedClassMetricsOut to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpectedClassMetricsOut input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ExpectedClass == input.ExpectedClass ||
                    (this.ExpectedClass != null &&
                    this.ExpectedClass.Equals(input.ExpectedClass))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ExpectedClass != null)
                    hashCode = hashCode * 59 + this.ExpectedClass.GetHashCode();
