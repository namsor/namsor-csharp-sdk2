...
namespace Org.OpenAPITools.com.namsor.sdk2.model
{
    ...
    public partial class FirstLastNameDiasporaedOut :  IEquatable<FirstLastNameDiasporaedOut>, IValidatableObject
    {
        ...
        public FirstLastNameDiasporaedOut(string id = default(string), string firstName = default(string), string lastName = default(string), double? score = default(double?), string ethnicityAlt = default(string), string ethnicity = default(string), bool? lifted = default(bool?), string countryIso2 = default(string))
        {
            this.Id = id;
