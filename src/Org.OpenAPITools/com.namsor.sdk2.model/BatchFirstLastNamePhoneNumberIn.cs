...
namespace Org.OpenAPITools.com.namsor.sdk2.model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BatchFirstLastNamePhoneNumberIn :  IEquatable<BatchFirstLastNamePhoneNumberIn>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchFirstLastNamePhoneNumberIn" /> class.
        /// </summary>
        /// <param name="personalNamesWithPhoneNumbers">personalNamesWithPhoneNumbers.</param>
        public BatchFirstLastNamePhoneNumberIn(List<FirstLastNamePhoneNumberIn> personalNamesWithPhoneNumbers = default(List<FirstLastNamePhoneNumberIn>))
        {
        ...
        public List<FirstLastNamePhoneNumberIn> PersonalNamesWithPhoneNumbers { get; set; }
        ...
        {
            return this.Equals(input as BatchFirstLastNamePhoneNumberIn);
        }

        /// <summary>
        /// Returns true if BatchFirstLastNamePhoneNumberIn instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchFirstLastNamePhoneNumberIn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchFirstLastNamePhoneNumberIn input)
        {
            if (input == null)
                return false;
