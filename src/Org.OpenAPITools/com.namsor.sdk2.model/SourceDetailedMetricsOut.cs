...
namespace Org.OpenAPITools.com.namsor.sdk2.model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SourceDetailedMetricsOut :  IEquatable<SourceDetailedMetricsOut>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SourceDetailedMetricsOut" /> class.
        /// </summary>
        ...
        /// <param name="expectedClassMetrics">expectedClassMetrics.</param>
        public SourceDetailedMetricsOut(string classifierName = default(string), APIKeyOut source = default(APIKeyOut), long? aiEstimateTotal = default(long?), double? aiEstimatePrecision = default(double?), double? aiEstimateRecall = default(double?), long? metricTimeStamp = default(long?), long? aiStartTime = default(long?), long? aiLearnTotal = default(long?), long? snapshotDate = default(long?), List<ExpectedClassMetricsOut> expectedClassMetrics = default(List<ExpectedClassMetricsOut>))
        {
        ...
        /// <summary>
        /// Gets or Sets ExpectedClassMetrics
        /// </summary>
        [DataMember(Name="expectedClassMetrics", EmitDefaultValue=false)]
        public List<ExpectedClassMetricsOut> ExpectedClassMetrics { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ExpectedClassMetrics: ").Append(ExpectedClassMetrics).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as SourceDetailedMetricsOut);
        }

        /// <summary>
        /// Returns true if SourceDetailedMetricsOut instances are equal
        /// </summary>
        /// <param name="input">Instance of SourceDetailedMetricsOut to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SourceDetailedMetricsOut input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ExpectedClassMetrics == input.ExpectedClassMetrics ||
                    this.ExpectedClassMetrics != null &&
                    this.ExpectedClassMetrics.SequenceEqual(input.ExpectedClassMetrics)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ExpectedClassMetrics != null)
                    hashCode = hashCode * 59 + this.ExpectedClassMetrics.GetHashCode();
                return hashCode;
            }
        }
