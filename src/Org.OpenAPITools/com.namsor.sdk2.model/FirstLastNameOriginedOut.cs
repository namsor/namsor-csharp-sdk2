...
namespace Org.OpenAPITools.com.namsor.sdk2.model
{
    ...
    public partial class FirstLastNameOriginedOut :  IEquatable<FirstLastNameOriginedOut>, IValidatableObject
    {
        ...
        /// <param name="countriesOriginTop">List countries of Origin (top 10).</param>
        ...
        public FirstLastNameOriginedOut(string id = default(string), string firstName = default(string), string lastName = default(string), string countryOrigin = default(string), string countryOriginAlt = default(string), List<string> countriesOriginTop = default(List<string>), double? score = default(double?), string regionOrigin = default(string), string topRegionOrigin = default(string), string subRegionOrigin = default(string), double? probabilityCalibrated = default(double?), double? probabilityAltCalibrated = default(double?))
        {
            this.Id = id;
        ...
        /// </summary>
        /// <value>List countries of Origin (top 10)</value>
        [DataMember(Name="countriesOriginTop", EmitDefaultValue=false)]
        public List<string> CountriesOriginTop { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CountriesOriginTop: ").Append(CountriesOriginTop).Append("\n");
        ...
        public bool Equals(FirstLastNameOriginedOut input)
        {
            ...
            return 
                ...
                (
                    this.CountriesOriginTop == input.CountriesOriginTop ||
                    this.CountriesOriginTop != null &&
                    this.CountriesOriginTop.SequenceEqual(input.CountriesOriginTop)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CountriesOriginTop != null)
                    hashCode = hashCode * 59 + this.CountriesOriginTop.GetHashCode();
                if (this.Score != null)
